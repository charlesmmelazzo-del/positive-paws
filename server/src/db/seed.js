...
You don't need to train every step of every walk. But dedicated 5-10 minute training periods during walks will build the skill.`,
    ...
    // âââ Lessons for Course 4: Advanced Real-World Training âââââââââââââââââââ
    const course4Lessons = [
      {
        title: 'Training in Real Environments',
        content: `## Taking Your Training Off the Mat

Most training starts in the living room â low distraction, familiar surroundings, a willing dog. But the real world is nothing like your living room. Cars backfire. Squirrels sprint. Children scream. Other dogs appear out of nowhere. This lesson is about bridging the gap between training sessions and real life.

### Why Dogs Struggle Outdoors

A dog who sits perfectly at home may blow you off completely at the park. This isn't disobedience â it's a failure to generalize. Dogs are highly context-specific learners. They don't automatically transfer a behavior from one environment to another; you have to teach it in each new context.
...
Build the behavior to fluency in a low-distraction environment. The dog should be responding reliably â about 90% of the time â before you add any difficulty.

**Phase 2: Proofing (introduce variables one at a time)**
Add distance, then duration, then distraction â but never more than one at a time. If you add distance and distraction simultaneously, you're setting the dog up to fail.
...
- **Short sessions**: 3â5 minutes of focused training in a new environment beats 30 minutes of struggling.
- **End on success**: Always finish with something the dog does easily so they leave the environment on a positive note.
- **Increase gradually**: Don't jump from the living room to the dog park. Build up: driveway â quiet street â park edge â park interior.`,
...
Training one dog is challenging. Training two or more â especially with different temperaments, ages, and training histories â adds an entirely new layer of complexity. This lesson covers how to manage and train a multi-dog household successfully.

### The Core Challenge: Competing for Resources

Most conflict in multi-dog homes comes down to resources: food, space, attention, toys, resting spots. Dogs don't share naturally â they negotiate through body language and, sometimes, conflict. Your job is to manage resources strategically so conflict doesn't arise.

**Key resource-management rules:**
- Feed dogs separately â in different rooms or with barriers â to prevent food guarding
...
Every dog in the household needs individual training time. If you always train them together, they'll learn to work as a pack â not independently. One dog who knows a command will cue the other to respond, and you'll never know if each dog truly understands the behavior.
...
1. **One dog on leash, one free** â work the leashed dog while the other is nearby but not interfering
2. **Both on leash** â practice sits, stays, and place behaviors with both dogs simultaneously
3. **Take turns** â cue Dog A, reward, then cue Dog B, reward. This teaches patience and impulse control.

### Introducing a New Dog

When adding a dog to the household, go slowly. The existing dog(s) should meet the newcomer on neutral ground (not at home), on leash, in parallel â walking together before greeting face to face. Don't force it. Let them set the pace.

For the first few weeks at home, manage carefully: separate feeding, supervised greetings, crates or gates when unsupervised. Most dogs take 2â3 weeks to settle into a new household dynamic.`,
...
Distractions are everywhere â other dogs, people, food on the ground, wildlife, traffic, children. A dog who can focus and respond to cues despite distractions is a genuinely well-trained dog. This lesson gives you a systematic approach.
...
**The goal of distraction training is to work just below threshold** â close enough to the distraction that the dog notices it, but not so close they lose their mind.

### The Distraction Hierarchy

Not all distractions are equal. Build a rough hierarchy for your dog:

Low: a person walking by â Medium: another dog at a distance â High: a squirrel running â Extreme: food dropped on the ground
...
How it works:
1. Dog sees distraction â mark ("yes!") â reward
2. Dog looks at distraction â looks back at you â jackpot reward
3. Eventually: dog sees distraction â automatically looks at you

This technique changes the emotional response to the distraction. The dog learns that seeing the distraction predicts rewards â and starts looking to you for guidance rather than reacting.

### Engagement Games

Building engagement â your dog's desire to check in with you â is the foundation of distraction proofing. Practice these:

- **Hand targeting**: dog touches your palm with their nose on cue, even near distractions
- **Name game**: say dog's name, mark and reward when they look at you â build this in increasingly distracting environments
- **Ready?**: use an attention cue before asking for any behavior in a distracting environment`,
        key_takeaway: 'Distraction training requires working below the dog\'s threshold and building up gradually. Techniques like "Look at That" change the emotional response to distractions â turning triggers into cues to check in with you.',
        order_index: 2,
        reading_time_minutes: 10,
      },
      {
...
A well-trained dog isn't just a dog who knows commands â it's a dog who is confident, emotionally resilient, and genuinely enjoys working with you. This final lesson is about the bigger picture: building a dog you can take anywhere and trust in any situation.
...
Real reliability comes from confidence â a dog who trusts that the world is safe, that new experiences are interesting rather than threatening, and that you are a reliable guide through it all.

**How to build confidence:**
- Expose to novelty early and often (new surfaces, sounds, environments, people)
- Let the dog problem-solve â don't over-help or rush to rescue them from minor challenges
- Use play as a training tool â a dog who plays with you in a new environment is a confident dog
- Celebrate "brave" moments: when your dog approaches something unfamiliar, mark and reward generously

### The Relationship Is the Foundation

Every technique in this program works better on a foundation of a strong relationship. A dog who trusts you, enjoys your company, and finds working with you rewarding will forgive your training mistakes â and there will be mistakes.
...
- Being the predictor of good things â your presence should reliably signal safety and reward

### Maintenance Training

Training is never "done." Behaviors that aren't practiced will fade â especially under real-world pressure. Maintenance training means:
...
- Continuing to add new behaviors throughout the dog's life â mental stimulation matters

### You've Come a Long Way

If you've worked through all four courses, you have a solid understanding of how dogs learn, how to communicate clearly, how to train foundational and advanced skills, and how to apply all of it in the real world. The most important thing now is consistency â show up, keep it positive, and enjoy your dog.`,
    ...
    const c4Questions = [
      ...
      [
        ...
        { question: "Why is the human-dog relationship described as 'the foundation' of training?", options: ["Because dogs will only work for owners they love", "Because a dog who trusts you and enjoys working with you will be more forgiving of training mistakes and more motivated to engage", "Because dominant owners get better results", "It isn't â technique is more important than relationship"], correct: 1, explanation: "A strong relationship means the dog is intrinsically motivated to work with you, recovers faster from confusing training moments, and finds your presence itself rewarding â all of which accelerate learning." },
        { question: "Maintenance training means:", options: ["Repeating the same training program from the beginning annually", "Continuing to practice known behaviors in new contexts throughout the dog's life", "Only training when the dog shows regression", "Training for 30 minutes every day without fail"], correct: 1, explanation: "Behaviors that aren't practiced fade, especially under real-world pressure. Regular maintenance â brief tune-up sessions, surprise recall rewards, new environments â keeps skills sharp and the dog engaged." },
      ],
    ];
